...
Section:NewButton("Key - Press To Copy Key To Clipboard ", "Press To Copy To Clipboard", function ()
    setclipboard('TR1V5_U8947598236498786UwU_Daddyj734924987234839')
end)
...
Section:NewButton("Shindo Life Script", "Press For Script", function ()
    Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/SxnwDev/Web/main/scripts/SnxwHub.txt"))()
end)